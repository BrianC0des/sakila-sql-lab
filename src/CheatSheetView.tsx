    ...
    <div className="h-full overflow-y-auto bg-slate-950 p-6 space-y-8 text-slate-200">
      ...
      <div className="border-b border-slate-800 pb-5">
        ...
        <div className="flex flex-wrap gap-1.5 mt-3 pt-3 border-t border-slate-800/80 text-[11px] font-mono">
          <a
            href="#local-setup"
            className="px-2.5 py-1 rounded bg-slate-900 hover:bg-slate-800 text-slate-300 hover:text-cyan-300 border border-slate-800 transition"
          >
            1. Local Setup
          </a>
          <a
            href="#execution-order"
            className="px-2.5 py-1 rounded bg-slate-900 hover:bg-slate-800 text-slate-300 hover:text-sky-300 border border-slate-800 transition"
          >
            2. Execution Order
          </a>
          <a
            href="#exam-traps"
            className="px-2.5 py-1 rounded bg-slate-900 hover:bg-slate-800 text-slate-300 hover:text-rose-300 border border-slate-800 transition"
          >
            3. Exam Traps
          </a>
          <a
            href="#query-patterns"
            className="px-2.5 py-1 rounded bg-slate-900 hover:bg-slate-800 text-slate-300 hover:text-amber-300 border border-slate-800 transition"
          >
            4. Query Shapes
          </a>
          <a
      ...
      {/* 1. Local Dev Environment: XAMPP, MySQL CLI, & Editor Setup */}
      <div id="local-setup" className="space-y-4 scroll-mt-6">
...
EXIT;                          -- Disconnect from MySQL CLI`}
      ...
      {/* 2. Conceptual Execution Order */}
      <div id="execution-order" className="space-y-3 pt-6 border-t border-slate-800/80 scroll-mt-6">
        <div className="flex items-center gap-2">
          <Layers className="w-4 h-4 text-amber-400" />
          <h3 className="text-sm font-bold text-slate-100 uppercase tracking-wide">
            2. Conceptual Query Execution Order (Very Important!)
          </h3>
        </div>
        <p className="text-xs text-slate-400">
      ...
      {/* 5. Active Database Schema Keys Reference */}
      <div id="schema-ref" className="space-y-3 pb-8 scroll-mt-6">
        <div className="flex items-center gap-2">
          <Database className="w-4 h-4 text-emerald-400" />
          <h3 className="text-sm font-bold text-slate-100 uppercase tracking-wide">
            5. Schema & Table Reference ({activeDbName})
          </h3>
        </div>
