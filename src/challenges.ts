...
export const sqlChallenges: SqlChallenge[] = [
  ...
  },
  {
    ...
    title: "Milestone 2: Relational Matching (INNER JOIN)",
  ...
  },
  {
    ...
    title: "Milestone 3: Data Aggregation (GROUP BY & COUNT)",
  ...
  },
  {
    ...
    title: "Milestone 4: Filtering Aggregates (HAVING)",
  ...
  },
  {
    ...
    title: "Milestone 5: Multi-Table Revenue Aggregation (JOIN + GROUP BY)",
  ...
  },
  {
    ...
    title: "Milestone 6: Many-to-Many INNER JOIN (Actor ↔ Film)",
  ...
  },
  {
    ...
    title: "Milestone 7: LEFT OUTER JOIN (Detecting Inactive Customers)",
  ...
  },
  {
    ...
    title: "Milestone 8: SELF JOIN (Pairing Rows from the Same Table)",
  ...
  },
  {
    ...
    title: "Milestone 9: Multi-Table Audit (Customer ↔ Rental ↔ Film ↔ Payment)",
  ...
  // ─── Stage 1 Redux: Retrieve Data ─────────────────────────────────────────

  {
    id: "sakila-10-like-wildcards",
    title: "Milestone 10: Pattern Matching (LIKE & Wildcards)",
  ...
  },
  {
    ...
    title: "Milestone 11: Unique Values (DISTINCT)",
  ...
  },
  {
    ...
    title: "Milestone 12: Range & List Filtering (BETWEEN + IN)",
  ...
  },
  {
    ...
    title: "Milestone 13: Handling NULL (IS NULL — Unreturned Rentals)",
...

  {
    ...
    title: "Milestone 14: Aggregate Functions (COUNT, MIN, MAX, AVG)",
  ...
  },
  {
    ...
    title: "Milestone 15: Grouping Rows (GROUP BY)",
  ...
  },
  {
    ...
    title: "Milestone 16: Filtering Groups (HAVING)",
  ...
  // ─── Stage 2 Continued: CASE WHEN ─────────────────────────────────────────

  {
    id: "sakila-17-case-length-category",
    title: "Milestone 17: Conditional Logic (CASE WHEN — Film Length)",
  ...
  },
  {
    ...
    title: "Milestone 18: Price Tiers (CASE WHEN — Rental Rate)",
  ...
  // ─── Stage 4: Complex Queries — Subqueries ────────────────────────────────

  {
    id: "sakila-19-subquery-scalar",
    title: "Milestone 19: Scalar Subquery (Films Above Average Price)",
  ...
  },
  {
    ...
    title: "Milestone 20: Subquery with IN (Customers Who Paid ≥ $4.99)",
  ...
  },
  {
    ...
    title: "Milestone 21: JOIN + GROUP BY (Customer Spend Summary)",
  ...
  },
  {
    ...
    title: "Milestone 22: LEFT JOIN + NULL Pattern (Customers With No Rentals)",
  ...
  },
  {
    ...
    title: "Milestone 23: JOIN + GROUP BY + HAVING (High-Value Customers)",
  ...
  // ─── Stage 1 Continued: Logical Operators & Filtering ────────────────────

  {
    id: "sakila-24-and-or-parentheses",
    title: "Milestone 24: Compound Logic (AND + OR with Parentheses)",
  ...
  },
  {
    ...
    title: "Milestone 25: Exclusion Filter (NOT IN)",
  ...
  },
  {
    ...
    title: "Milestone 26: IS NOT NULL (Returned Rentals)",
  ...
  },
  {
    ...
    title: "Milestone 27: Pagination (LIMIT + OFFSET)",
  ...
  },
  {
    ...
    title: "Milestone 28: NOT IN Subquery (Customers With No Payments)",
  ...
  },
  {
    ...
    title: "Milestone 29: Films Rented More Than Once (JOIN + GROUP BY + HAVING)",
  ...
  },
  {
    ...
    title: "Milestone 30: CASE WHEN + GROUP BY (Films Per Price Tier)",
  ...
  },
  {
    ...
    title: "Milestone 31: WHERE + GROUP BY + HAVING Together (Active Customer Spend)",
  ...
  },
  {
    ...
    title: "Milestone 32: 5-Table Revenue by Genre (Ultimate JOIN Challenge)",
  ...
  },
  {
    ...
    title: "Milestone 33: Self-Join — Films with the Same Rental Rate & Rating",
  ...
  },
  {
    ...
    title: "Milestone 34: COUNT(*) vs COUNT(column) — Returned vs Total Rentals",
  ...
  },
  {
    ...
    title: "Milestone 35: DATE() Aggregation — Daily Revenue Report",
  ...
  },
  {
    ...
    title: "Milestone 36: LEFT JOIN Filter in ON vs WHERE — Premium Payment Trap",
