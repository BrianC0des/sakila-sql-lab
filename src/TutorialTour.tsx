...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    description:
      "Switch here to review local XAMPP & MySQL CLI setup, 7-step conceptual query execution order (FROM → WHERE → GROUP BY → ...), 5 common exam traps, 7 query shapes, and active schema reference.",
